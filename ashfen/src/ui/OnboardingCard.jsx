  ...
  return (
    <div className="absolute flex items-center justify-center"
      ...
      <div style={{
        ...
        <div className="uppercase" style={{ fontFamily: SERIF, fontSize: 9, letterSpacing: "0.22em", color: C.inkSoft }}>
          Level
        </div>
        <div style={{ fontSize: 19, marginBottom: 8 }}>{LEVEL_NAME}</div>
        <div style={{ fontFamily: SERIF, fontSize: 12, color: C.ink, lineHeight: 1.7 }}>
          <div>Defeat every enemy unit to win.</div>
          <div>Tap a unit, tap a tile to move, then choose an action.</div>
          <div>Zoom with the buttons at the bottom right, or scroll or pinch. Zoomed in, drag to look around.</div>
